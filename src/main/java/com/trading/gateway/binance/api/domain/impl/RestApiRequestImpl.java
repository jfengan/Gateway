...
import com.trading.gateway.binance.api.domain.utils.BinanceApiSignature;
import com.trading.gateway.utils.websocket.RequestOptions;
import com.trading.gateway.utils.websocket.RestApiRequestInterface;
import com.trading.gateway.utils.websocket.impl.utils.RestApiRequest;
import com.trading.gateway.utils.websocket.impl.utils.JsonWrapperArray;
...
public class RestApiRequestImpl implements RestApiRequestInterface {
    ...
    public Request createRequestWithSignature(String url, String address, UrlParamsBuilder builder) {
        ...
        String requestUrl = url + address;
        new BinanceApiSignature().createSignature(apiKey, secretKey, builder);
        if (builder.hasPostParam()) {
    ...
    public Request createRequestWithApikey(String url, String address, UrlParamsBuilder builder) {
        if (builder == null) {
            throw new ApiException(ApiException.RUNTIME_ERROR,
                    "[Invoking] Builder is null when create request with Signature");
        }
